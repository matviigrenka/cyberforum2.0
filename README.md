...
- Регистрация/вход.
- Создание всех 3 типов постов (`Regular`, `Voting`, `Quiz`).
- Голосование и проценты по вариантам.
- Подсветка ответов в викторине.
- Переключение `Private/Public` и удаление своего поста.
- API-эндпоинты и пример со сторонним API погоды.
